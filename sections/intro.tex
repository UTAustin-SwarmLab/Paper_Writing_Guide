...
First, describe the 4-5 key sub-topics your work relates to. For each, cite several papers and, crucially, describe how their approach \textit{differs} from yours or is complementary. Do not simply state what each paper does, but emphasize why it differs. Some people prefer to describe one closest competitor paper in detail: ``\SC{The closest work to ours is \cite{alvar2019multi}. The key difference of our approach is we \ldots}''.
